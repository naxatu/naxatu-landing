                    ...
                    <div className="faq-block">
                        <article className="faq-item">
                            ...
                            <p className="paragraph faq-item__answer">
                                ...
                                Никто, никого не обманывает - все собранные деньги будут
                                потрачены мне на квартиру в ЖК Rybalsky.
                                <br/><br/>
                                Даже есть трансляция происходящего в Telegram - {' '}
                        ...
                        <article className="faq-item">
                            ...
                            <p className="paragraph faq-item__answer">
                                ...
                                <br/><br/>
                                Но также, я хочу показать, что с помощью ICO и краутфандинга можно
                                не только нагло отбирать у людей деньги, заставляя их верить в нерелизуемые проекты.
