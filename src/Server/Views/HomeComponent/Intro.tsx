            ...
            <section className="section -intro intro" id="intro">
                ...
                <div className="section-content intro-content">
                    <div className="intro-logo__container">
                        <img src="/image/logo-white.svg"
                             title="Лебедев обзавидуется от такого лого"
                             alt="Логотип XATA"
                    ...
                    <div className="intro-buttons">
                        <a href="#ico"
                           ...
                           title="Вот нажми и узри как надо делать ICO!">Подкинуть на Хату</a>
                    </div>
                </div>
                ...
                <div className="intro-disclaimer">
                    ...
                    <a href="#ico"
                       ...
                       title="Нажми на эту кнопку и у тебя появиться шанс">Дать ему →</a>
                </div>
            </section>
        )
    }
